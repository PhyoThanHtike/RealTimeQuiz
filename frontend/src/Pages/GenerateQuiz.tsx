...
import { generateQuizForRoom } from '@/apiEndpoints/Room';
          ...
          <div className="p-1 bg-gradient-to-r from-blue-600 to-indigo-600">
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-2xl font-bold text-gray-800">Quiz Creation Wizard</h2>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <motion.div variants={itemVariants}>
                  ...
                  <Textarea
                    ...
                    className="min-h-[140px] text-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    required
                  />
                </motion.div>
                ...
                <motion.div variants={itemVariants}>
                  ...
                  <motion.label 
                    ...
                    whileTap={{ scale: 0.99 }}
                    className="flex flex-col items-center justify-center w-full p-8 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all bg-gray-50"
                  >
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm text-gray-600 text-center">
                        ...
                        <br />
                        <span className="text-xs text-gray-500">PDF, DOCX, TXT (Max 10MB)</span>
                      </p>
                    </div>
                    <input 
                      id="file" 
                ...
                <motion.div variants={itemVariants} className="pt-6 border-t border-gray-200">
                  <Button 
                    type="submit" 
                    className="w-full py-7 text-lg font-medium bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-lg"
